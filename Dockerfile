...
RUN apt-get update && \
    ...
    && python3 -m pip install --no-cache-dir --break-system-packages jax tensorflowjs onnx2tf sng4onnx onnx_graphsurgeon onnxslim onnxruntime ai-edge-litert ultralytics imagehash \
